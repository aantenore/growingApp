...
export default class Cart extends React.Component {
    ...
    static getDerivedStateFromProps(props,state){
        console.log(props);
        if(props.productToAdd!=undefined&&global.CANIADD){
        let productList = list;
        let productToAdd = props.productToAdd.type=='fixed'?{key:props.productToAdd.key}:props.productToAdd;
        list.push(productToAdd);
        global.CANIADD=false;
        list=productList;
        console.log("Now the cart is: ",list);
        }
        return null;
    }
